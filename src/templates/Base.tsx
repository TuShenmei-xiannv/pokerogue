    ...
    <div className="flex flex-col">
      ...
      <section className="relative py-20">
        ...
        <div className="absolute inset-x-0 top-0 flex justify-center">
          <div className="h-20 w-1 bg-gradient-to-b from-blue-400/50 to-transparent"></div>
        </div>
        <div className="absolute inset-x-0 top-20 h-40 bg-gradient-to-b from-[#1A237E]/90 via-transparent to-transparent backdrop-blur-sm"></div>

        <GameFeatures />

        {/* Bottom decorative elements */}
        <div className="absolute inset-x-0 bottom-0 flex justify-center">
          <div className="h-20 w-1 bg-gradient-to-t from-purple-400/50 to-transparent"></div>
        </div>
      </section>
      ...
      <section className="relative py-20">
        {/* Top decorative elements */}
        <div className="absolute inset-x-0 top-0 h-32 bg-gradient-to-b from-[#1A237E]/90 to-transparent backdrop-blur-sm"></div>
        <div className="absolute inset-x-0 top-0 flex justify-center">
        ...
        {/* Bottom decorative elements */}
        <div className="absolute inset-x-0 bottom-0 h-32 bg-gradient-to-t from-[#1A237E]/95 to-transparent"></div>
      </section>
